package ${package}.${projectNameLowerCase}.mda;
		...
		return NodeConfig.builder()
				...
				.addModule(ModuleConfig.builder("ressources")
						.addDefinitionProvider(DefinitionProviderConfig.builder(DynamoDefinitionProvider.class)
								.addDefinitionResource("kpr", "${packageInPathFormat}/${projectNameLowerCase}/gen.kpr")
								.build())
						.build())
				// ---StudioFeature
				.addModule(new StudioFeatures()
						.withMasterData()
						.withMda(
								Param.of("projectPackageName", "${package}.${projectNameLowerCase}"))
