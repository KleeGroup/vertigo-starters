...
public final class ApplicationUser implements Entity {
	...
	private final VAccessor<lollipop.domain.users.Profil> proIdAccessor = new VAccessor<>(lollipop.domain.users.Profil.class, "Profil");
	 ...
	 */
	public VAccessor<lollipop.domain.users.Profil> profil() {
