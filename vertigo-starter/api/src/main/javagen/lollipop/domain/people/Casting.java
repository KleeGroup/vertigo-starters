...
public final class Casting implements Entity {
	...
	private final VAccessor<lollipop.domain.people.People> peoIdAccessor = new VAccessor<>(lollipop.domain.people.People.class, "People");
	...
	@io.vertigo.dynamo.domain.stereotype.Association(
			...
			foreignLabel = "Casting",
			foreignMultiplicity = "0..*")
	private final VAccessor<lollipop.domain.movies.Movie> movIdAccessor = new VAccessor<>(lollipop.domain.movies.Movie.class, "Movie");
	 ...
	 */
	public VAccessor<lollipop.domain.movies.Movie> movie() {
	 ...
	 */
	public VAccessor<lollipop.domain.people.People> people() {
