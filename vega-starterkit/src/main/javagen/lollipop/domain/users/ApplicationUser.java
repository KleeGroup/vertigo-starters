...
public final class ApplicationUser implements Entity {
	...
	private final StoreVAccessor<lollipop.domain.users.Profil> proIdAccessor = new StoreVAccessor<>(lollipop.domain.users.Profil.class, "Profil");
	 ...
	 */
	public StoreVAccessor<lollipop.domain.users.Profil> profil() {
