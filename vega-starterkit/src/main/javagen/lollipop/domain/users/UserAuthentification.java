...
public final class UserAuthentification implements Entity {
	...
	private final StoreVAccessor<lollipop.domain.users.ApplicationUser> usrIdAccessor = new StoreVAccessor<>(lollipop.domain.users.ApplicationUser.class, "ApplicationUser");
	 ...
	 */
	public StoreVAccessor<lollipop.domain.users.ApplicationUser> applicationUser() {
