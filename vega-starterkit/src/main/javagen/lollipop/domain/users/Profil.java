...
public final class Profil implements Entity {
	...
	private final StoreListVAccessor<lollipop.domain.users.SecurityRole> securityRoleAccessor = new StoreListVAccessor<>(this, "StAnnProSro", "SecurityRole");
	 ...
	 */
	public StoreListVAccessor<lollipop.domain.users.SecurityRole> securityRole() {
