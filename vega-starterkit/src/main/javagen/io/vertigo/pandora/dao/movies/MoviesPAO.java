...
public final class MoviesPAO implements StoreServices {
 ...
 "				where MOV_ID in (#movieIds.rownum#);",
	...
	public io.vertigo.dynamo.domain.model.DtList<lollipop.domain.movies.MovieIndex> loadMovieIndex(@io.vertigo.dynamo.task.proxy.TaskInput(name = "movieIds", domain = "STyId") final java.util.List<Long> movieIds) {
