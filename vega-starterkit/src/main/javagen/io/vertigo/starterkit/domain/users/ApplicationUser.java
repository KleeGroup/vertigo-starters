...
public final class ApplicationUser implements Entity {
	...
	private final VAccessor<io.vertigo.starterkit.domain.users.Profil> proIdAccessor = new VAccessor<>(io.vertigo.starterkit.domain.users.Profil.class, "Profil");
	 ...
	 */
	public VAccessor<io.vertigo.starterkit.domain.users.Profil> profil() {
