...
public final class ApplicationUser implements Entity {
	...
	private Long proId;
	private io.vertigo.starterkit.domain.users.Profil profil;
	...
	/**
	 * Association : Profil.
	 * @return io.vertigo.starterkit.domain.users.Profil
	 */
	public io.vertigo.starterkit.domain.users.Profil getProfil() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.starterkit.domain.users.Profil> fkURI = getProfilURI();
		if (fkURI == null) {
			return null;
		}
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.starterkit.domain.users.Profil> getProfilURI() {
		return io.vertigo.dynamo.domain.util.DtObjectUtil.createURI(this, "A_USR_PRO", io.vertigo.starterkit.domain.users.Profil.class);
	}
