...
public final class Profil implements Entity {
	...
	private final ListVAccessor<io.vertigo.starterkit.domain.users.SecurityRole> securityRoleAccessor = new ListVAccessor<>(this, "ANN_PRO_SRO", "SecurityRole");
	 ...
	 */
	public ListVAccessor<io.vertigo.starterkit.domain.users.SecurityRole> securityRole() {
