...
public final class Profil implements Entity {
	...
	private io.vertigo.dynamo.domain.model.DtList<io.vertigo.starterkit.domain.users.SecurityRole> securityRole;
	 ...
	 * @return io.vertigo.dynamo.domain.model.DtList<io.vertigo.starterkit.domain.users.SecurityRole>
	 */
	public io.vertigo.dynamo.domain.model.DtList<io.vertigo.starterkit.domain.users.SecurityRole> getSecurityRoleList() {
//		return this.<io.vertigo.starterkit.domain.users.SecurityRole> getList(getSecurityRoleListURI());
		...
		if (io.vertigo.dynamo.domain.util.DtObjectUtil.getId(this) == null) {
			return new io.vertigo.dynamo.domain.model.DtList<>(io.vertigo.starterkit.domain.users.SecurityRole.class);
		}
