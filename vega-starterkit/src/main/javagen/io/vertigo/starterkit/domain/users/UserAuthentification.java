...
public final class UserAuthentification implements Entity {
	...
	private final VAccessor<io.vertigo.starterkit.domain.users.ApplicationUser> usrIdAccessor = new VAccessor<>(io.vertigo.starterkit.domain.users.ApplicationUser.class, "ApplicationUser");
	 ...
	 */
	public VAccessor<io.vertigo.starterkit.domain.users.ApplicationUser> applicationUser() {
