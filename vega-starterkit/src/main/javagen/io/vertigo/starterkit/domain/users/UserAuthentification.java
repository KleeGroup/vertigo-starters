...
public final class UserAuthentification implements Entity {
	...
	private Long usrId;
	private io.vertigo.starterkit.domain.users.ApplicationUser applicationUser;
	 ...
	 * @return io.vertigo.starterkit.domain.users.ApplicationUser
	 */
	public io.vertigo.starterkit.domain.users.ApplicationUser getApplicationUser() {
		final io.vertigo.dynamo.domain.model.URI<io.vertigo.starterkit.domain.users.ApplicationUser> fkURI = getApplicationUserURI();
		if (fkURI == null) {
			return null;
		}
	...
	public io.vertigo.dynamo.domain.model.URI<io.vertigo.starterkit.domain.users.ApplicationUser> getApplicationUserURI() {
		return io.vertigo.dynamo.domain.util.DtObjectUtil.createURI(this, "A_AUTH_USR", io.vertigo.starterkit.domain.users.ApplicationUser.class);
	}
